...
class Policy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: CustomText(text: AllString.policyTitle, fontSize: 18.sp, color: MyColors.blue2)),
        body: Container(
          ...
          child: ListView(
            ...
            children: [
              CustomText(text: AllString.policyTitle, fontSize: 18.sp, color: MyColors.blue1),
